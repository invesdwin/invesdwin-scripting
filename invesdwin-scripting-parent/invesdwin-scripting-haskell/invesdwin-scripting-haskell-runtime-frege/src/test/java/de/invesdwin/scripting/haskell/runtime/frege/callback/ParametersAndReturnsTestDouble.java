...
public class ParametersAndReturnsTestDouble {
    ...
    public ParametersAndReturnsTestDouble(final IScriptTaskRunnerHaskell runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        new AScriptTaskHaskell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDouble.class.getSimpleName() + ".fr",
