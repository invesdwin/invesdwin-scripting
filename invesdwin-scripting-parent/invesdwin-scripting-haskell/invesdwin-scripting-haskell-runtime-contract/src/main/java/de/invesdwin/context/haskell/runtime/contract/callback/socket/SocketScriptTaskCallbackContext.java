package de.invesdwin.context.haskell.runtime.contract.callback.socket;
...
import de.invesdwin.context.haskell.runtime.contract.callback.ScriptTaskParametersHaskellFromJson;
import de.invesdwin.context.haskell.runtime.contract.callback.ScriptTaskParametersHaskellFromJsonPool;
import de.invesdwin.context.haskell.runtime.contract.callback.ScriptTaskReturnsHaskellToExpression;
import de.invesdwin.context.haskell.runtime.contract.callback.ScriptTaskReturnsHaskellToExpressionPool;
...
public class SocketScriptTaskCallbackContext implements Closeable {
    ...
    public void init(final IScriptTaskEngine engine) {
        ...
        engine.eval(new ClassPathResource(SocketScriptTaskCallbackContext.class.getSimpleName() + ".hs",
