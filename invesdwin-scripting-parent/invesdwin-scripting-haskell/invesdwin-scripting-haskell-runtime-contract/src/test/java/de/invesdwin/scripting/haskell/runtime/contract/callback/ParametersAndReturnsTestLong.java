...
public class ParametersAndReturnsTestLong {
    ...
    public ParametersAndReturnsTestLong(final IScriptTaskRunnerHaskell runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        new AScriptTaskHaskell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestLong.class.getSimpleName() + ".hs",
