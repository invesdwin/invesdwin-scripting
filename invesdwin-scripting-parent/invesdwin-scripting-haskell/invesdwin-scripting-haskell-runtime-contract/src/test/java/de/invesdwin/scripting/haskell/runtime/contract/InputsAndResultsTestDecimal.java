...
public class InputsAndResultsTestDecimal {
    ...
    public InputsAndResultsTestDecimal(final IScriptTaskRunnerHaskell runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        ...
        new AScriptTaskHaskell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDecimal.class.getSimpleName() + ".hs",
