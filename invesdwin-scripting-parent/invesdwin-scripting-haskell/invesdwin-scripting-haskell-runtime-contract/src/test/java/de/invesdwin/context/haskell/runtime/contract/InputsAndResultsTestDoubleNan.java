...
public class InputsAndResultsTestDoubleNan {
    ...
    public InputsAndResultsTestDoubleNan(final IScriptTaskRunnerHaskell runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        ...
        new AScriptTaskHaskell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDoubleNan.class.getSimpleName() + ".hs",
