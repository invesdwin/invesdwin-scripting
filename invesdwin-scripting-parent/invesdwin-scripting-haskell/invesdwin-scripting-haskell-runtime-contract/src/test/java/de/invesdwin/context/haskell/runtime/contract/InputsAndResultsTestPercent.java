...
public class InputsAndResultsTestPercent {
    ...
    public InputsAndResultsTestPercent(final IScriptTaskRunnerHaskell runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        ...
        new AScriptTaskHaskell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestPercent.class.getSimpleName() + ".hs",
