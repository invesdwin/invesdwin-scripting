...
public class InputsAndResultsTestShort {
    ...
    public InputsAndResultsTestShort(final IScriptTaskRunnerHaskell runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        ...
        new AScriptTaskHaskell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestShort.class.getSimpleName() + ".hs",
