...
public class InputsAndResultsTestLong {
    ...
    public InputsAndResultsTestLong(final IScriptTaskRunnerHaskell runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        ...
        new AScriptTaskHaskell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestLong.class.getSimpleName() + ".hs",
