...
public class InputsAndResultsTestString {
    ...
    public InputsAndResultsTestString(final IScriptTaskRunnerHaskell runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        ...
        new AScriptTaskHaskell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestString.class.getSimpleName() + ".hs",
