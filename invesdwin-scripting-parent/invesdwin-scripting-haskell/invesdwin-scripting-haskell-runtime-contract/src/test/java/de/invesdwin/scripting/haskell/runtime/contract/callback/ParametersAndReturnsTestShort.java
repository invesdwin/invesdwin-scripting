...
public class ParametersAndReturnsTestShort {
    ...
    public ParametersAndReturnsTestShort(final IScriptTaskRunnerHaskell runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        new AScriptTaskHaskell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestShort.class.getSimpleName() + ".hs",
