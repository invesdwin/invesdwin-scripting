...
@NotThreadSafe
public class Python4jScriptTaskResultsPython implements IScriptTaskResultsPython {

    private final Python4jScriptTaskEnginePython engine;

    public Python4jScriptTaskResultsPython(final Python4jScriptTaskEnginePython engine) {
        this.engine = engine;
    }
