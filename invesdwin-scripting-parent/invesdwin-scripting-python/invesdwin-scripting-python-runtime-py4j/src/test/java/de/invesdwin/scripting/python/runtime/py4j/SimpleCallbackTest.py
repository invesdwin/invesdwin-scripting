...
getSecretStaticGateway = gateway.jvm.de.invesdwin.scripting.python.runtime.py4j.SimpleCallbackTest.getSecretStatic(putUuid)
print("getSecretStaticGateway")
print(getSecretStaticGateway)

java_import(gateway.jvm,'de.invesdwin.scripting.python.runtime.py4j.SimpleCallbackTest')
