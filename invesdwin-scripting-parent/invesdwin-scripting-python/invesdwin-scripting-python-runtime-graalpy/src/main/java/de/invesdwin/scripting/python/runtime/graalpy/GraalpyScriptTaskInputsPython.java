...
@NotThreadSafe
public class GraalpyScriptTaskInputsPython implements IScriptTaskInputsPython {

    private final GraalpyScriptTaskEnginePython engine;

    public GraalpyScriptTaskInputsPython(final GraalpyScriptTaskEnginePython engine) {
        this.engine = engine;
    }
