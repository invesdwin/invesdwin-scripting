...
@NotThreadSafe
public class LibpythoncljScriptTaskResultsPython implements IScriptTaskResultsPython {

    private final LibpythoncljScriptTaskEnginePython engine;

    public LibpythoncljScriptTaskResultsPython(final LibpythoncljScriptTaskEnginePython engine) {
        this.engine = engine;
    }

    @Override
    public LibpythoncljScriptTaskEnginePython getEngine() {
        return engine;
    }
