...
@NotThreadSafe
public class LibpythoncljScriptTaskInputsPython implements IScriptTaskInputsPython {

    private final LibpythoncljScriptTaskEnginePython engine;

    public LibpythoncljScriptTaskInputsPython(final LibpythoncljScriptTaskEnginePython engine) {
        this.engine = engine;
    }
