...
@NotThreadSafe
public class ScriptTaskResultsGroovy implements IScriptTaskResults {

    private final ScriptTaskEngineGroovy engine;

    public ScriptTaskResultsGroovy(final ScriptTaskEngineGroovy engine) {
        this.engine = engine;
    }

    @Override
    public ScriptTaskEngineGroovy getEngine() {
        return engine;
    }
