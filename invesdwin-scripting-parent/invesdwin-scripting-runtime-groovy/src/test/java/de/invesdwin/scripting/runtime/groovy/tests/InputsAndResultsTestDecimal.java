...
public class InputsAndResultsTestDecimal {
    ...
    public InputsAndResultsTestDecimal(final IScriptTaskRunnerGroovy runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        ...
        new AScriptTaskGroovy<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDecimal.class.getSimpleName() + ".groovy",
