package de.invesdwin.scripting.runtime.groovy.tests;
...
public class InputsAndResultsTestNullPutGet {
    ...
    public InputsAndResultsTestNullPutGet(final IScriptTaskRunnerGroovy runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskGroovy<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestNullPutGet.class.getSimpleName() + ".groovy",
