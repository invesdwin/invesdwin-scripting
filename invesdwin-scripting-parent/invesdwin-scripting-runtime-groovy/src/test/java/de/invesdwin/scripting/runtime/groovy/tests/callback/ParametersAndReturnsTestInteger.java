...
public class ParametersAndReturnsTestInteger {
    ...
    public ParametersAndReturnsTestInteger(final IScriptTaskRunnerGroovy runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        new AScriptTaskGroovy<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestInteger.class.getSimpleName() + ".groovy",
