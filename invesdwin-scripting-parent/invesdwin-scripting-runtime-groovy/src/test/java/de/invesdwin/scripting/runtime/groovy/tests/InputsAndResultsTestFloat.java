...
public class InputsAndResultsTestFloat {
    ...
    public InputsAndResultsTestFloat(final IScriptTaskRunnerGroovy runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        ...
        new AScriptTaskGroovy<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestFloat.class.getSimpleName() + ".groovy",
