...
public class InputsAndResultsTestEmpty {
    ...
    public InputsAndResultsTestEmpty(final IScriptTaskRunnerGroovy runner) {
        this.runner = runner;
    }
    ...
    public void testEmpty() {
        ...
        new AScriptTaskGroovy<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmpty.class.getSimpleName() + ".groovy",
