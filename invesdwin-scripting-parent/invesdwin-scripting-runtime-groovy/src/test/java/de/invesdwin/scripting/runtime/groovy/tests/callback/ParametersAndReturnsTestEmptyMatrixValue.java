package de.invesdwin.scripting.runtime.groovy.tests.callback;
...
public class ParametersAndReturnsTestEmptyMatrixValue {
    ...
    public ParametersAndReturnsTestEmptyMatrixValue(final IScriptTaskRunnerGroovy runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        new AScriptTaskGroovy<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(
                        ParametersAndReturnsTestEmptyMatrixValue.class.getSimpleName() + ".groovy",
