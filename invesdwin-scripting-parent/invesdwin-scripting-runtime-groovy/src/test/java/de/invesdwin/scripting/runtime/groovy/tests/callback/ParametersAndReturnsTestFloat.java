...
public class ParametersAndReturnsTestFloat {
    ...
    public ParametersAndReturnsTestFloat(final IScriptTaskRunnerGroovy runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        new AScriptTaskGroovy<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestFloat.class.getSimpleName() + ".groovy",
