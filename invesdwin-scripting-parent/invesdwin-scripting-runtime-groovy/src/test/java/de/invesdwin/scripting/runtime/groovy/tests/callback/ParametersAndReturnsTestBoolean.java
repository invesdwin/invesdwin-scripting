...
public class ParametersAndReturnsTestBoolean {
    ...
    public ParametersAndReturnsTestBoolean(final IScriptTaskRunnerGroovy runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        new AScriptTaskGroovy<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestBoolean.class.getSimpleName() + ".groovy",
