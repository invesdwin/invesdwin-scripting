...
public class ParametersAndReturnsTestDecimal {
    ...
    public ParametersAndReturnsTestDecimal(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDecimal.class.getSimpleName() + ".js",
