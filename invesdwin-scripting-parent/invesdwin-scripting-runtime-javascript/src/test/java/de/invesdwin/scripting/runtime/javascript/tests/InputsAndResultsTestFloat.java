...
public class InputsAndResultsTestFloat {
    ...
    public InputsAndResultsTestFloat(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        ...
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestFloat.class.getSimpleName() + ".js",
