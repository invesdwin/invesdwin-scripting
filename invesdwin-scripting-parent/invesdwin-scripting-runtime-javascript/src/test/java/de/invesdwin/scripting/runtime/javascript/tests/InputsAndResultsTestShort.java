...
public class InputsAndResultsTestShort {
    ...
    public InputsAndResultsTestShort(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        ...
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestShort.class.getSimpleName() + ".js",
