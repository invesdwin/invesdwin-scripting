package de.invesdwin.scripting.runtime.javascript.tests;
...
public class InputsAndResultsTestNullPutGet {
    ...
    public InputsAndResultsTestNullPutGet(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestNullPutGet.class.getSimpleName() + ".js",
