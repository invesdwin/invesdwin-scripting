...
public class InputsAndResultsTestDecimal {
    ...
    public InputsAndResultsTestDecimal(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        ...
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDecimal.class.getSimpleName() + ".js",
