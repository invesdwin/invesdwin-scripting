...
public class ParametersAndReturnsTestBoolean {
    ...
    public ParametersAndReturnsTestBoolean(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestBoolean.class.getSimpleName() + ".js",
