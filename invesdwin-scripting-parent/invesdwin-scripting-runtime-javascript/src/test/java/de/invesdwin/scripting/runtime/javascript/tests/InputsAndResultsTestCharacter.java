...
public class InputsAndResultsTestCharacter {
    ...
    public InputsAndResultsTestCharacter(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        ...
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestCharacter.class.getSimpleName() + ".js",
