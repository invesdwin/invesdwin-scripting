...
public class InputsAndResultsTestInteger {
    ...
    public InputsAndResultsTestInteger(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        ...
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestInteger.class.getSimpleName() + ".js",
