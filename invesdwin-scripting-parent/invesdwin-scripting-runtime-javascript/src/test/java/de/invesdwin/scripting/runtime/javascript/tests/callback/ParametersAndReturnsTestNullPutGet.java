...
public class ParametersAndReturnsTestNullPutGet {
    ...
    public ParametersAndReturnsTestNullPutGet(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestNullPutGet.class.getSimpleName() + ".js",
