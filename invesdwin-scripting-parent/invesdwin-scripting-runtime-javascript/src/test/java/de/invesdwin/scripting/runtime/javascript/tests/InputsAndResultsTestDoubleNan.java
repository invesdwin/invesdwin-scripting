...
public class InputsAndResultsTestDoubleNan {
    ...
    public InputsAndResultsTestDoubleNan(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        ...
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDoubleNan.class.getSimpleName() + ".js",
