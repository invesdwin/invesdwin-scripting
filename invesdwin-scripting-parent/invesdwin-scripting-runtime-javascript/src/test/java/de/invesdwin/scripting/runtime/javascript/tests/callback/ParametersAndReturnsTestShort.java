...
public class ParametersAndReturnsTestShort {
    ...
    public ParametersAndReturnsTestShort(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestShort.class.getSimpleName() + ".js",
