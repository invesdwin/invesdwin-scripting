...
public class InputsAndResultsTestPercent {
    ...
    public InputsAndResultsTestPercent(final IScriptTaskRunnerJavascript runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        ...
        new AScriptTaskJavascript<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestPercent.class.getSimpleName() + ".js",
