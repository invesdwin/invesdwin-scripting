...
@NotThreadSafe
public class ScriptTaskResultsJavascript implements IScriptTaskResults {

    private final ScriptTaskEngineJavascript engine;

    public ScriptTaskResultsJavascript(final ScriptTaskEngineJavascript engine) {
        this.engine = engine;
    }

    @Override
    public ScriptTaskEngineJavascript getEngine() {
        return engine;
    }
