...
function callback(methodName, ...parameters) {
    if(typeof javascriptScriptTaskCallbackContext === 'undefined') {
        if(typeof javascriptScriptTaskCallbackContextUuid !== 'undefined') {
            javascriptScriptTaskCallbackContext = Java.type('de.invesdwin.scripting.runtime.javascript.callback.JavascriptScriptTaskCallbackContext').getContext(javascriptScriptTaskCallbackContextUuid);
        } else {
