...
@NotThreadSafe
public class ScriptTaskResultsJshell implements IScriptTaskResults {

    private final ScriptTaskEngineJshell engine;

    public ScriptTaskResultsJshell(final ScriptTaskEngineJshell engine) {
        this.engine = engine;
    }

    @Override
    public ScriptTaskEngineJshell getEngine() {
        return engine;
    }
