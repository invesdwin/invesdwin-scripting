...
public class ParametersAndReturnsTestEmpty {
    ...
    public ParametersAndReturnsTestEmpty(final IScriptTaskRunnerJshell runner) {
        this.runner = runner;
    }
    ...
    public void testEmpty() {
        new AScriptTaskJshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestEmpty.class.getSimpleName() + ".jsh",
