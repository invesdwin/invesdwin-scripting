...
public class InputsAndResultsTestDouble {
    ...
    public InputsAndResultsTestDouble(final IScriptTaskRunnerJshell runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        ...
        new AScriptTaskJshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDouble.class.getSimpleName() + ".jsh",
