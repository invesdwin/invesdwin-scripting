...
public class InputsAndResultsTestBoolean {
    ...
    public InputsAndResultsTestBoolean(final IScriptTaskRunnerJshell runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        ...
        new AScriptTaskJshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestBoolean.class.getSimpleName() + ".jsh",
