...
public class ParametersAndReturnsTestFloat {
    ...
    public ParametersAndReturnsTestFloat(final IScriptTaskRunnerJshell runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        new AScriptTaskJshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestFloat.class.getSimpleName() + ".jsh",
