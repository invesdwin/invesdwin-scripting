package de.invesdwin.scripting.runtime.jshell.tests;
...
public class InputsAndResultsTestEmptyMatrixValue {
    ...
    public InputsAndResultsTestEmptyMatrixValue(final IScriptTaskRunnerJshell runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        ...
        new AScriptTaskJshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmptyMatrixValue.class.getSimpleName() + ".jsh",
