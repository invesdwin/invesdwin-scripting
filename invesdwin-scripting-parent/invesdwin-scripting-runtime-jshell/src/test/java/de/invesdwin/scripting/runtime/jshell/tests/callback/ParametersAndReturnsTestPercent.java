...
public class ParametersAndReturnsTestPercent {
    ...
    public ParametersAndReturnsTestPercent(final IScriptTaskRunnerJshell runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        new AScriptTaskJshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestPercent.class.getSimpleName() + ".jsh",
