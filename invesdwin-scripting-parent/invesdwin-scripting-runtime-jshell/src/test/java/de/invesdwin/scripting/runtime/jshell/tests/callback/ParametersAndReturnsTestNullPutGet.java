package de.invesdwin.scripting.runtime.jshell.tests.callback;
...
public class ParametersAndReturnsTestNullPutGet {
    ...
    public ParametersAndReturnsTestNullPutGet(final IScriptTaskRunnerJshell runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskJshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestNullPutGet.class.getSimpleName() + ".jsh",
