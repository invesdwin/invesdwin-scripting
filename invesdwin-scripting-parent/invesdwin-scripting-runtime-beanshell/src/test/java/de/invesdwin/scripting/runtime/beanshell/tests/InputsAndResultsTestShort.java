...
public class InputsAndResultsTestShort {
    ...
    public InputsAndResultsTestShort(final IScriptTaskRunnerBeanshell runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        ...
        new AScriptTaskBeanshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestShort.class.getSimpleName() + ".bsh",
