...
public class ParametersAndReturnsTestBoolean {
    ...
    public ParametersAndReturnsTestBoolean(final IScriptTaskRunnerBeanshell runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        new AScriptTaskBeanshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestBoolean.class.getSimpleName() + ".bsh",
