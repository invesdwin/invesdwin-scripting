...
public class InputsAndResultsTestByte {
    ...
    public InputsAndResultsTestByte(final IScriptTaskRunnerBeanshell runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        ...
        new AScriptTaskBeanshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestByte.class.getSimpleName() + ".bsh",
