...
public class InputsAndResultsTestPercent {
    ...
    public InputsAndResultsTestPercent(final IScriptTaskRunnerBeanshell runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        ...
        new AScriptTaskBeanshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestPercent.class.getSimpleName() + ".bsh",
