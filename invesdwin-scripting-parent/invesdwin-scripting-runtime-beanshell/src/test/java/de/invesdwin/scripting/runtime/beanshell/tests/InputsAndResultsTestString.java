...
public class InputsAndResultsTestString {
    ...
    public InputsAndResultsTestString(final IScriptTaskRunnerBeanshell runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        ...
        new AScriptTaskBeanshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestString.class.getSimpleName() + ".bsh",
