...
public class InputsAndResultsTestCharacter {
    ...
    public InputsAndResultsTestCharacter(final IScriptTaskRunnerBeanshell runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        ...
        new AScriptTaskBeanshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestCharacter.class.getSimpleName() + ".bsh",
