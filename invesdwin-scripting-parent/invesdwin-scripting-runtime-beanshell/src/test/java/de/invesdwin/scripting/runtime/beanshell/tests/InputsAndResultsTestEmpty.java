...
public class InputsAndResultsTestEmpty {
    ...
    public InputsAndResultsTestEmpty(final IScriptTaskRunnerBeanshell runner) {
        this.runner = runner;
    }
    ...
    public void testEmpty() {
        ...
        new AScriptTaskBeanshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmpty.class.getSimpleName() + ".bsh",
