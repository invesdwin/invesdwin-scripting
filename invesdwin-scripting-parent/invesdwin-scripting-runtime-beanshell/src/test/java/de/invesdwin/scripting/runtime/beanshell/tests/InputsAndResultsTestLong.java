...
public class InputsAndResultsTestLong {
    ...
    public InputsAndResultsTestLong(final IScriptTaskRunnerBeanshell runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        ...
        new AScriptTaskBeanshell<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestLong.class.getSimpleName() + ".bsh",
