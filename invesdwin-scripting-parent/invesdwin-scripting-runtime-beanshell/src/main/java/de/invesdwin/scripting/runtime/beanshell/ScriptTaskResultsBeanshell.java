...
@NotThreadSafe
public class ScriptTaskResultsBeanshell implements IScriptTaskResults {

    private final ScriptTaskEngineBeanshell engine;

    public ScriptTaskResultsBeanshell(final ScriptTaskEngineBeanshell engine) {
        this.engine = engine;
    }

    @Override
    public ScriptTaskEngineBeanshell getEngine() {
        return engine;
    }
