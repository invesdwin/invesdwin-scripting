...
@NotThreadSafe
public class ScriptTaskResultsMvel implements IScriptTaskResults {

    private final ScriptTaskEngineMvel engine;

    public ScriptTaskResultsMvel(final ScriptTaskEngineMvel engine) {
        this.engine = engine;
    }

    @Override
    public ScriptTaskEngineMvel getEngine() {
        return engine;
    }
