...
@Immutable
@Named
public final class ProvidedScriptTaskRunnerMvel
        implements IScriptTaskRunnerMvel, FactoryBean<ProvidedScriptTaskRunnerMvel> {

    public static final String PROVIDED_INSTANCE_KEY = IScriptTaskRunnerMvel.class.getName();

    public static final ProvidedScriptTaskRunnerMvel INSTANCE = new ProvidedScriptTaskRunnerMvel();

    @GuardedBy("this.class")
    private static IScriptTaskRunnerMvel providedInstance;

    private ProvidedScriptTaskRunnerMvel() {}

    public static synchronized IScriptTaskRunnerMvel getProvidedInstance() {
        if (providedInstance == null) {
            ...
            if (systemProperties.containsValue(PROVIDED_INSTANCE_KEY)) {
                try {
                    ...
                    return (IScriptTaskRunnerMvel) Reflections.classForName(runner).newInstance();
    ...
    public static synchronized void setProvidedInstance(final IScriptTaskRunnerMvel providedInstance) {
        ProvidedScriptTaskRunnerMvel.providedInstance = providedInstance;
        final SystemProperties systemProperties = new SystemProperties();
        if (providedInstance == null) {
    ...
    public Class<?> getObjectType() {
        return ProvidedScriptTaskRunnerMvel.class;
    }
    ...
    @Override
    public ProvidedScriptTaskRunnerMvel getObject() throws Exception {
        return INSTANCE;
    }
