...
public class ParametersAndReturnsTestByte {
    ...
    public ParametersAndReturnsTestByte(final IScriptTaskRunnerMvel runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        new AScriptTaskMvel<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestByte.class.getSimpleName() + ".mvel",
