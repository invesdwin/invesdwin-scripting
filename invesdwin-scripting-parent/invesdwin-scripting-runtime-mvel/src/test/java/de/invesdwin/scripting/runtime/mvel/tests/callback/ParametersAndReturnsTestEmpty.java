...
public class ParametersAndReturnsTestEmpty {
    ...
    public ParametersAndReturnsTestEmpty(final IScriptTaskRunnerMvel runner) {
        this.runner = runner;
    }
    ...
    public void testEmpty() {
        new AScriptTaskMvel<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestEmpty.class.getSimpleName() + ".mvel",
