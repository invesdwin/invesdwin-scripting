...
public class ParametersAndReturnsTestDecimal {
    ...
    public ParametersAndReturnsTestDecimal(final IScriptTaskRunnerMvel runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        new AScriptTaskMvel<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDecimal.class.getSimpleName() + ".mvel",
