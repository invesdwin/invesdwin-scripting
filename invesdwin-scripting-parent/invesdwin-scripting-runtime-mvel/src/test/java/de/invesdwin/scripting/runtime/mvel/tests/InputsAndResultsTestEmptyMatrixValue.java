package de.invesdwin.scripting.runtime.mvel.tests;
...
public class InputsAndResultsTestEmptyMatrixValue {
    ...
    public InputsAndResultsTestEmptyMatrixValue(final IScriptTaskRunnerMvel runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        ...
        new AScriptTaskMvel<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmptyMatrixValue.class.getSimpleName() + ".mvel",
