...
public class ParametersAndReturnsTestPercent {
    ...
    public ParametersAndReturnsTestPercent(final IScriptTaskRunnerMvel runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        new AScriptTaskMvel<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestPercent.class.getSimpleName() + ".mvel",
