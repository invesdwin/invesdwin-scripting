...
public class InputsAndResultsTestString {
    ...
    public InputsAndResultsTestString(final IScriptTaskRunnerMvel runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        ...
        new AScriptTaskMvel<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestString.class.getSimpleName() + ".mvel",
