...
public class ParametersAndReturnsTestCharacter {
    ...
    public ParametersAndReturnsTestCharacter(final IScriptTaskRunnerMvel runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        new AScriptTaskMvel<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestCharacter.class.getSimpleName() + ".mvel",
