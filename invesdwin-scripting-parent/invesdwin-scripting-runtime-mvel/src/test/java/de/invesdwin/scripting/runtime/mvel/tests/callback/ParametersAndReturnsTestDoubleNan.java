...
public class ParametersAndReturnsTestDoubleNan {
    ...
    public ParametersAndReturnsTestDoubleNan(final IScriptTaskRunnerMvel runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        new AScriptTaskMvel<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDoubleNan.class.getSimpleName() + ".mvel",
