...
public class InputsAndResultsTestFloat {
    ...
    public InputsAndResultsTestFloat(final IScriptTaskRunnerMvel runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        ...
        new AScriptTaskMvel<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestFloat.class.getSimpleName() + ".mvel",
