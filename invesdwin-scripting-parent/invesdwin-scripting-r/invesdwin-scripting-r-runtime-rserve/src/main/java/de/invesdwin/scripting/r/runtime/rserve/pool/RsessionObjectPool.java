package de.invesdwin.scripting.r.runtime.rserve.pool;
...
import de.invesdwin.scripting.r.runtime.rserve.RserveProperties;
import de.invesdwin.scripting.r.runtime.rserve.RserveScriptTaskEngineR;
import de.invesdwin.scripting.r.runtime.rserve.RserverConfMode;
...
public final class RsessionObjectPool extends ATimeoutObjectPool<ExtendedRserveSession>
    ...
    private ExtendedRserveSession createSession() {
        final de.invesdwin.scripting.r.runtime.rserve.pool.internal.RsessionLogger log = new de.invesdwin.scripting.r.runtime.rserve.pool.internal.RsessionLogger();
