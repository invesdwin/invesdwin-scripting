...
public class ParametersAndReturnsTestDecimal {
    ...
    public ParametersAndReturnsTestDecimal(final IScriptTaskRunnerRuby runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        new AScriptTaskRuby<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDecimal.class.getSimpleName() + ".rb",
