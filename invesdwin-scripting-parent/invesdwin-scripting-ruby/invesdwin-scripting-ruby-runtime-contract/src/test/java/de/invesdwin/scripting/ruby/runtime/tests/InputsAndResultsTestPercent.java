...
public class InputsAndResultsTestPercent {
    ...
    public InputsAndResultsTestPercent(final IScriptTaskRunnerRuby runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        ...
        new AScriptTaskRuby<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestPercent.class.getSimpleName() + ".rb",
