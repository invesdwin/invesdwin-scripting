...
public class InputsAndResultsTestCharacter {
    ...
    public InputsAndResultsTestCharacter(final IScriptTaskRunnerRuby runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        ...
        new AScriptTaskRuby<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestCharacter.class.getSimpleName() + ".rb",
