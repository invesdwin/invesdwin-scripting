...
public class InputsAndResultsTestInteger {
    ...
    public InputsAndResultsTestInteger(final IScriptTaskRunnerRuby runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        ...
        new AScriptTaskRuby<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestInteger.class.getSimpleName() + ".rb",
