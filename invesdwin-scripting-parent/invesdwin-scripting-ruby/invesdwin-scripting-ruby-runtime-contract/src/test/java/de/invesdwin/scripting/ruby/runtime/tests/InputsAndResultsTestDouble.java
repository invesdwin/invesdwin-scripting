...
public class InputsAndResultsTestDouble {
    ...
    public InputsAndResultsTestDouble(final IScriptTaskRunnerRuby runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        ...
        new AScriptTaskRuby<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDouble.class.getSimpleName() + ".rb",
