package de.invesdwin.scripting.ruby.runtime.tests.callback;
...
public class ParametersAndReturnsTestEmptyMatrixValue {
    ...
    public ParametersAndReturnsTestEmptyMatrixValue(final IScriptTaskRunnerRuby runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        new AScriptTaskRuby<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(
                        new ClassPathResource(ParametersAndReturnsTestEmptyMatrixValue.class.getSimpleName() + ".rb",
