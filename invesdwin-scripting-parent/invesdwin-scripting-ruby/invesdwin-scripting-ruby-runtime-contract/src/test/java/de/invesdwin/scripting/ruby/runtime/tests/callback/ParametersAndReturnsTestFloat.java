...
public class ParametersAndReturnsTestFloat {
    ...
    public ParametersAndReturnsTestFloat(final IScriptTaskRunnerRuby runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        new AScriptTaskRuby<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestFloat.class.getSimpleName() + ".rb",
