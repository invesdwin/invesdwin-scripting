...
public class ParametersAndReturnsTestString {
    ...
    public ParametersAndReturnsTestString(final IScriptTaskRunnerRuby runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        new AScriptTaskRuby<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestString.class.getSimpleName() + ".rb",
