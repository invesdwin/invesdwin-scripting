...
@NotThreadSafe
public class TrufflerubyScriptTaskResultsRuby implements IScriptTaskResultsRuby {

    private final TrufflerubyScriptTaskEngineRuby engine;

    public TrufflerubyScriptTaskResultsRuby(final TrufflerubyScriptTaskEngineRuby engine) {
        this.engine = engine;
    }
