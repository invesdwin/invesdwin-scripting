...
import de.invesdwin.scripting.ruby.runtime.IScriptTaskResultsRuby;
...
@NotThreadSafe
public class JrubyScriptTaskResultsRuby implements IScriptTaskResultsRuby {

    private final JrubyScriptTaskEngineRuby engine;

    public JrubyScriptTaskResultsRuby(final JrubyScriptTaskEngineRuby engine) {
        this.engine = engine;
    }

    @Override
    public JrubyScriptTaskEngineRuby getEngine() {
        return engine;
    }
    ...
    public boolean isNull(final String variable) {
        return engine.unwrap().get(variable) == null;
    }
