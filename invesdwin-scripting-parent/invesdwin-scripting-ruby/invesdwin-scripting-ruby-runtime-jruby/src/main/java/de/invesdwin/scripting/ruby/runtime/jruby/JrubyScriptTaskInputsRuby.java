...
import de.invesdwin.scripting.ruby.runtime.IScriptTaskInputsRuby;

@NotThreadSafe
public class JrubyScriptTaskInputsRuby implements IScriptTaskInputsRuby {

    private final JrubyScriptTaskEngineRuby engine;

    public JrubyScriptTaskInputsRuby(final JrubyScriptTaskEngineRuby engine) {
        this.engine = engine;
    }
