...
@NotThreadSafe
public class ScriptTaskResultsScala implements IScriptTaskResults {

    private final ScriptTaskEngineScala engine;

    public ScriptTaskResultsScala(final ScriptTaskEngineScala engine) {
        this.engine = engine;
    }

    @Override
    public ScriptTaskEngineScala getEngine() {
        return engine;
    }
