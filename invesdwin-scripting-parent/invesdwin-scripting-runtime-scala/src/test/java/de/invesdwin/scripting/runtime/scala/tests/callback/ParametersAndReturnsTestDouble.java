...
public class ParametersAndReturnsTestDouble {
    ...
    public ParametersAndReturnsTestDouble(final IScriptTaskRunnerScala runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        new AScriptTaskScala<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDouble.class.getSimpleName() + ".scala",
