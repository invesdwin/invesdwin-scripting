...
public class InputsAndResultsTestEmpty {
    ...
    public InputsAndResultsTestEmpty(final IScriptTaskRunnerScala runner) {
        this.runner = runner;
    }
    ...
    public void testEmpty() {
        ...
        new AScriptTaskScala<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmpty.class.getSimpleName() + ".scala",
