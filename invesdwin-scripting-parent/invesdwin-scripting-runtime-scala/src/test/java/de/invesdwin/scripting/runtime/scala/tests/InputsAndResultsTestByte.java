...
public class InputsAndResultsTestByte {
    ...
    public InputsAndResultsTestByte(final IScriptTaskRunnerScala runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        ...
        new AScriptTaskScala<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestByte.class.getSimpleName() + ".scala",
