...
public class ParametersAndReturnsTestDoubleNan {
    ...
    public ParametersAndReturnsTestDoubleNan(final IScriptTaskRunnerScala runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        new AScriptTaskScala<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDoubleNan.class.getSimpleName() + ".scala",
