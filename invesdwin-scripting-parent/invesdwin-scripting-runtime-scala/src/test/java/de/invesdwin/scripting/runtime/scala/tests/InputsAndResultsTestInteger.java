...
public class InputsAndResultsTestInteger {
    ...
    public InputsAndResultsTestInteger(final IScriptTaskRunnerScala runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        ...
        new AScriptTaskScala<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestInteger.class.getSimpleName() + ".scala",
