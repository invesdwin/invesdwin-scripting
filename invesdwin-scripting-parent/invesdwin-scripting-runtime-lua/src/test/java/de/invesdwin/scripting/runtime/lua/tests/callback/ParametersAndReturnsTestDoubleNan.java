...
public class ParametersAndReturnsTestDoubleNan {
    ...
    public ParametersAndReturnsTestDoubleNan(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDoubleNan.class.getSimpleName() + ".lua",
