...
public class ParametersAndReturnsTestCharacter {
    ...
    public ParametersAndReturnsTestCharacter(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestCharacter.class.getSimpleName() + ".lua",
