package de.invesdwin.scripting.runtime.lua.tests.callback;
...
public class ParametersAndReturnsTestEmptyMatrixValue {
    ...
    public ParametersAndReturnsTestEmptyMatrixValue(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }

    public void testEmptyMatrixValue() {
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(
                        new ClassPathResource(ParametersAndReturnsTestEmptyMatrixValue.class.getSimpleName() + ".lua",
