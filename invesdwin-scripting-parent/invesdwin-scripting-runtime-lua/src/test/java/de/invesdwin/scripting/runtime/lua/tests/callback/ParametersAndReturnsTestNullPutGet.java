...
public class ParametersAndReturnsTestNullPutGet {
    ...
    public ParametersAndReturnsTestNullPutGet(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestNullPutGet.class.getSimpleName() + ".lua",
