...
public class InputsAndResultsTestBoolean {
    ...
    public InputsAndResultsTestBoolean(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        ...
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestBoolean.class.getSimpleName() + ".lua",
