...
public class ParametersAndReturnsTestInteger {
    ...
    public ParametersAndReturnsTestInteger(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestInteger.class.getSimpleName() + ".lua",
