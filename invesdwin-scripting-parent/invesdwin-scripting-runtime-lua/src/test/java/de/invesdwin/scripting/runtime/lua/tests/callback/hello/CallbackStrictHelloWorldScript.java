package de.invesdwin.scripting.runtime.lua.tests.callback.hello;
...
public class CallbackStrictHelloWorldScript {
    ...
    public CallbackStrictHelloWorldScript(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testHelloWorld() {
        ...
        final AScriptTaskLua<String> script = new AScriptTaskLua<String>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(CallbackStrictHelloWorldScript.class.getSimpleName() + ".lua",
                        getClass()));
            }
