...
public class ParametersAndReturnsTestString {
    ...
    public ParametersAndReturnsTestString(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestString.class.getSimpleName() + ".lua",
