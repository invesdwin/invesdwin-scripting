...
public class InputsAndResultsTestInteger {
    ...
    public InputsAndResultsTestInteger(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        ...
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestInteger.class.getSimpleName() + ".lua",
