...
public class ParametersAndReturnsTestLong {
    ...
    public ParametersAndReturnsTestLong(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestLong.class.getSimpleName() + ".lua",
