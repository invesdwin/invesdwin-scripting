...
public class InputsAndResultsTestString {
    ...
    public InputsAndResultsTestString(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        ...
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestString.class.getSimpleName() + ".lua",
