...
public class InputsAndResultsTestDouble {
    ...
    public InputsAndResultsTestDouble(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        ...
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDouble.class.getSimpleName() + ".lua",
