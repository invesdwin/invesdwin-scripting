...
public class ParametersAndReturnsTestByte {
    ...
    public ParametersAndReturnsTestByte(final IScriptTaskRunnerLua runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        new AScriptTaskLua<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestByte.class.getSimpleName() + ".lua",
