...
public class ParametersAndReturnsTestInteger {
    ...
    public ParametersAndReturnsTestInteger(final IScriptTaskRunnerJulia runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        new AScriptTaskJulia<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestInteger.class.getSimpleName() + ".jl",
