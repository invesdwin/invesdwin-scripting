...
public class InputsAndResultsTestNullPutGet {
    ...
    public InputsAndResultsTestNullPutGet(final IScriptTaskRunnerRust runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskRust<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestNullPutGet.class.getSimpleName() + ".rs",
