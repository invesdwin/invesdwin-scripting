...
public class InputsAndResultsTestDouble {
    ...
    public InputsAndResultsTestDouble(final IScriptTaskRunnerRust runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        ...
        new AScriptTaskRust<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDouble.class.getSimpleName() + ".rs",
