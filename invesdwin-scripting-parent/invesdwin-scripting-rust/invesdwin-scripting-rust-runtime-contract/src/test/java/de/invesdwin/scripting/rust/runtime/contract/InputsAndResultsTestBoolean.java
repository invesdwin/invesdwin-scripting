...
public class InputsAndResultsTestBoolean {
    ...
    public InputsAndResultsTestBoolean(final IScriptTaskRunnerRust runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        ...
        new AScriptTaskRust<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestBoolean.class.getSimpleName() + ".rs",
