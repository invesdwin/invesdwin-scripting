...
public class InputsAndResultsTestDecimal {
    ...
    public InputsAndResultsTestDecimal(final IScriptTaskRunnerRust runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        ...
        new AScriptTaskRust<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDecimal.class.getSimpleName() + ".rs",
