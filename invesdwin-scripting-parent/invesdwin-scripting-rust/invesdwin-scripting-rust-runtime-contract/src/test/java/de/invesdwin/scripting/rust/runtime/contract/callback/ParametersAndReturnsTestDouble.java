...
public class ParametersAndReturnsTestDouble {
    ...
    public ParametersAndReturnsTestDouble(final IScriptTaskRunnerRust runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        new AScriptTaskRust<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDouble.class.getSimpleName() + ".rs",
