...
public class InputsAndResultsTestEmptyMatrixValue {
    ...
    public InputsAndResultsTestEmptyMatrixValue(final IScriptTaskRunnerRust runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        ...
        new AScriptTaskRust<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmptyMatrixValue.class.getSimpleName() + ".rs",
