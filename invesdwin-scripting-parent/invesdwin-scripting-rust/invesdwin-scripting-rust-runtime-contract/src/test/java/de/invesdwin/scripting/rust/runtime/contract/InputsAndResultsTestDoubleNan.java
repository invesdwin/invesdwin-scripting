...
public class InputsAndResultsTestDoubleNan {
    ...
    public InputsAndResultsTestDoubleNan(final IScriptTaskRunnerRust runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        ...
        new AScriptTaskRust<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDoubleNan.class.getSimpleName() + ".rs",
