...
public class ParametersAndReturnsTestEmpty {
    ...
    public ParametersAndReturnsTestEmpty(final IScriptTaskRunnerRust runner) {
        this.runner = runner;
    }

    public void testEmpty() {
        new AScriptTaskRust<Void>() {
            private final ParametersAndReturnsTestEmptyCallback callback = new ParametersAndReturnsTestEmptyCallback();
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestEmpty.class.getSimpleName() + ".rs",
