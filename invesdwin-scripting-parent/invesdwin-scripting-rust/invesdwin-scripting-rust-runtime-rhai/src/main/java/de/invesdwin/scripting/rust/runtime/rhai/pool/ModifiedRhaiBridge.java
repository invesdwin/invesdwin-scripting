...
import de.invesdwin.scripting.rust.runtime.rhai.RhaiProperties;
 ...
 */
@NotThreadSafe
public class ModifiedRhaiBridge {
    ...
    private ModifiedRhaiErrorConsoleWatcher errWatcher = null;
     ...
     */
    public ModifiedRhaiBridge() {
        final List<String> j = new ArrayList<String>();
        j.add(RhaiProperties.RHAI_COMMAND);
    ...
    public ModifiedRhaiErrorConsoleWatcher getErrWatcher() {
        return errWatcher;
    }
    ...
    public void open() throws IOException {
        ...
        errWatcher = new ModifiedRhaiErrorConsoleWatcher(python);
