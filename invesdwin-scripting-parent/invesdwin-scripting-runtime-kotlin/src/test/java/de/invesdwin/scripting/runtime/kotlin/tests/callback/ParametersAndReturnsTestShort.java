...
public class ParametersAndReturnsTestShort {
    ...
    public ParametersAndReturnsTestShort(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestShort.class.getSimpleName() + ".kts",
