...
public class InputsAndResultsTestDecimal {
    ...
    public InputsAndResultsTestDecimal(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        ...
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDecimal.class.getSimpleName() + ".kts",
