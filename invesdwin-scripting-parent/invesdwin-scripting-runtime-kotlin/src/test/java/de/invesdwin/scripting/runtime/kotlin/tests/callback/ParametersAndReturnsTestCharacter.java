...
public class ParametersAndReturnsTestCharacter {
    ...
    public ParametersAndReturnsTestCharacter(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestCharacter.class.getSimpleName() + ".kts",
