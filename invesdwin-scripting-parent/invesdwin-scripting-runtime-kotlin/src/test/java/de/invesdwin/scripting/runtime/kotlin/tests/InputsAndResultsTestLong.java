...
public class InputsAndResultsTestLong {
    ...
    public InputsAndResultsTestLong(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        ...
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestLong.class.getSimpleName() + ".kts",
