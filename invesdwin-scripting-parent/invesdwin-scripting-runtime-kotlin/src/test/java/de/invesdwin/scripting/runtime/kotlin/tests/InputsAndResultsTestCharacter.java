...
public class InputsAndResultsTestCharacter {
    ...
    public InputsAndResultsTestCharacter(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        ...
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestCharacter.class.getSimpleName() + ".kts",
