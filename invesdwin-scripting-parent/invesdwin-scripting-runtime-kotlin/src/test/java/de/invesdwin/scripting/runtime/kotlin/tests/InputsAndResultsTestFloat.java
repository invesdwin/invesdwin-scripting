...
public class InputsAndResultsTestFloat {
    ...
    public InputsAndResultsTestFloat(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        ...
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestFloat.class.getSimpleName() + ".kts",
