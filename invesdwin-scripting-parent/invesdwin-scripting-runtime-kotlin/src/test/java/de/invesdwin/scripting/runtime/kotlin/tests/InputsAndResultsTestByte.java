...
public class InputsAndResultsTestByte {
    ...
    public InputsAndResultsTestByte(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        ...
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestByte.class.getSimpleName() + ".kts",
