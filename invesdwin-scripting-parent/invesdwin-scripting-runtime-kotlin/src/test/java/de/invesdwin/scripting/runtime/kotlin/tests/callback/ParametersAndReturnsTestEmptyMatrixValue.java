package de.invesdwin.scripting.runtime.kotlin.tests.callback;
...
import de.invesdwin.scripting.runtime.kotlin.AScriptTaskKotlin;
import de.invesdwin.scripting.runtime.kotlin.IScriptTaskRunnerKotlin;
...
public class ParametersAndReturnsTestEmptyMatrixValue {
    ...
    public ParametersAndReturnsTestEmptyMatrixValue(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(
                        new ClassPathResource(ParametersAndReturnsTestEmptyMatrixValue.class.getSimpleName() + ".kts",
