...
public class ParametersAndReturnsTestLong {
    ...
    public ParametersAndReturnsTestLong(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestLong.class.getSimpleName() + ".kts",
