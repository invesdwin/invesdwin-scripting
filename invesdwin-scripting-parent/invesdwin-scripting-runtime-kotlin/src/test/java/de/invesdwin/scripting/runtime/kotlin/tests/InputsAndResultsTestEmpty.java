...
public class InputsAndResultsTestEmpty {
    ...
    public InputsAndResultsTestEmpty(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testEmpty() {
        ...
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmpty.class.getSimpleName() + ".kts",
