...
public class ParametersAndReturnsTestString {
    ...
    public ParametersAndReturnsTestString(final IScriptTaskRunnerKotlin runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        new AScriptTaskKotlin<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestString.class.getSimpleName() + ".kts",
