...
@NotThreadSafe
public class ScriptTaskResultsClojure implements IScriptTaskResults {

    private final ScriptTaskEngineClojure engine;

    public ScriptTaskResultsClojure(final ScriptTaskEngineClojure engine) {
        this.engine = engine;
    }

    @Override
    public ScriptTaskEngineClojure getEngine() {
        return engine;
    }
