...
@Immutable
@Named
public final class ProvidedScriptTaskRunnerClojure
        implements IScriptTaskRunnerClojure, FactoryBean<ProvidedScriptTaskRunnerClojure> {

    public static final String PROVIDED_INSTANCE_KEY = IScriptTaskRunnerClojure.class.getName();

    public static final ProvidedScriptTaskRunnerClojure INSTANCE = new ProvidedScriptTaskRunnerClojure();
        ...
        if (providedInstance == null) {
            ...
            if (systemProperties.containsValue(PROVIDED_INSTANCE_KEY)) {
                try {
                    ...
                    return (IScriptTaskRunnerClojure) Reflections.classForName(runner).newInstance();
    ...
    public static synchronized void setProvidedInstance(final IScriptTaskRunnerClojure providedInstance) {
        ProvidedScriptTaskRunnerClojure.providedInstance = providedInstance;
        final SystemProperties systemProperties = new SystemProperties();
        if (providedInstance == null) {
    ...
    public Class<?> getObjectType() {
        return ProvidedScriptTaskRunnerClojure.class;
    }
    ...
    @Override
    public ProvidedScriptTaskRunnerClojure getObject() throws Exception {
        return INSTANCE;
    }
