...
@NotThreadSafe
public class ScriptTaskInputsClojure implements IScriptTaskInputs {

    private final ScriptTaskEngineClojure engine;

    public ScriptTaskInputsClojure(final ScriptTaskEngineClojure engine) {
        this.engine = engine;
    }
    ...
    public void putExpression(final String variable, final String expression) {
        engine.unwrap().eval("(def " + variable + " " + expression + ")");
    }
