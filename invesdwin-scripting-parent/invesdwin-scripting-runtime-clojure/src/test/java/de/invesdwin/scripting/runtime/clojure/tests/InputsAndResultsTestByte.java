...
public class InputsAndResultsTestByte {
    ...
    public InputsAndResultsTestByte(final IScriptTaskRunnerClojure runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        ...
        new AScriptTaskClojure<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestByte.class.getSimpleName() + ".clj",
