...
public class InputsAndResultsTestNullPutGet {
    ...
    public InputsAndResultsTestNullPutGet(final IScriptTaskRunnerClojure runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskClojure<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestNullPutGet.class.getSimpleName() + ".clj",
