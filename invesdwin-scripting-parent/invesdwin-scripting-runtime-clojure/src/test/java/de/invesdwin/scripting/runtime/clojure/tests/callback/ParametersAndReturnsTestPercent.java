...
public class ParametersAndReturnsTestPercent {
    ...
    public ParametersAndReturnsTestPercent(final IScriptTaskRunnerClojure runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        new AScriptTaskClojure<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestPercent.class.getSimpleName() + ".clj",
