...
public class ParametersAndReturnsTestByte {
    ...
    public ParametersAndReturnsTestByte(final IScriptTaskRunnerClojure runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        new AScriptTaskClojure<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestByte.class.getSimpleName() + ".clj",
