...
public class InputsAndResultsTestBoolean {
    ...
    public InputsAndResultsTestBoolean(final IScriptTaskRunnerClojure runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        ...
        new AScriptTaskClojure<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestBoolean.class.getSimpleName() + ".clj",
