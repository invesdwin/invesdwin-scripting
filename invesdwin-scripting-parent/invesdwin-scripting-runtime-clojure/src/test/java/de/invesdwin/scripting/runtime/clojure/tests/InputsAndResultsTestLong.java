...
public class InputsAndResultsTestLong {
    ...
    public InputsAndResultsTestLong(final IScriptTaskRunnerClojure runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        ...
        new AScriptTaskClojure<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestLong.class.getSimpleName() + ".clj",
